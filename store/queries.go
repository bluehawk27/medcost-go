...
const insertProvider = `INSERT INTO provider (provider_id, name, street, city, zip_code, state, hrr_description, created_at, lat, long) VALUES (:provider_id, :name, :street, :city, :zip_code, :state, :hrr_description, :created_at, :lat, :long)`
...
const insertInpatientService = `INSERT INTO inpatient (provider_id, drg_id, total_discharges, avg_covered_discharges, avg_total_payments, avg_medicare_payments, year, created_at) VALUES (:provider_id, :drg_id, :total_discharges, :avg_covered_discharges, :avg_total_payments, :avg_medicare_payments, :year, :created_at)`
